...
namespace BirdsCommonStandard
{
    ...
    public abstract class BaseInpc/*(Predicate<BaseInpc>? previewRaisePropertyChanged)*/ : INotifyPropertyChanged
    {
        ...
        private readonly Predicate<BaseInpc> previewRaisePropertyChanged;

        protected BaseInpc(Predicate<BaseInpc> previewRaisePropertyChanged = null)
        {
            this.previewRaisePropertyChanged = previewRaisePropertyChanged ?? (_ => true);
        }
        ...
        /// <summary>Защищённый метод для создания события <see cref="PropertyChanged"/>.</summary>
        /// <param name="args"><see cref="PropertyChangedEventArgs"/> с именем изменившегося свойства
        /// или <see cref="string.Empty">string.Empty</see>, или <see langword="null"/>.</param>
        ...
        {
            if(ReferenceEquals(propertyName, null)) throw new ArgumentNullException(nameof(propertyFiled));
        ...
        protected static readonly PropertyChangedEventArgs AllPropertyChangedEventArgs = new PropertyChangedEventArgs(string.Empty);
    }
